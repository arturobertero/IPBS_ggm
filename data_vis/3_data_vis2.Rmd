...
plot_1 <- ggplot(df, aes(x = Min_wage, y = Adopt)) +
  geom_point(size = 1) +
  labs(x = "Support for minimum wage", y = "Support for step child adoption", 
...
ggsave(here("Processing", "Figure_4.jpg"), plottt, width = 18, height = 9)
```
...
scatter_plot <- ggplot(data_high_low, aes(x = Min_wage, y = Adopt, color = factor(Relig))) +
  ...
  labs(x = "Support for minimum wage", y = "Support for stepchild adoption", title = "High tightness, low consensus") +
...
ggsave(here("Processing", "high_low.jpg"), width = 8, height = 4.5)
...
scatter_plot <- ggplot(data_low_low, aes(x = Min_wage, y = Adopt, color = factor(Relig))) +
  ...
  labs(x = "Support for minimum wage", y = "Support for stepchild adoption", title = "Low tightness, low consensus") +
  scale_color_manual(values = c("0" = "#00BFFF", "1" = "#E4717A"), labels = c("0" = "No", "1" = "Yes")) +  # Define colors and labels for Relig
  guides(color = guide_legend(title = "Relig"))  # Add legend with the title "Relig"
...
# Display the scatterplot with the added text
ggsave(here("Processing", "low_low.jpg"), width = 8, height = 4.5)
...
scatter_plot <- ggplot(data_high_high, aes(x = Min_wage, y = Adopt, color = factor(Relig))) +
  ...
  labs(x = "Support for minimum wage", y = "Support for stepchild adoption", title = "High tightness, high consensus") +
  scale_color_manual(values = c("0" = "#00BFFF", "1" = "#E4717A"), labels = c("0" = "No", "1" = "Yes")) +  # Define colors and labels for Relig
  guides(color = guide_legend(title = "Relig"))  # Add legend with the title "Relig"
...
# Display the scatterplot with the added text
ggsave(here("Processing", "high_high.jpg"), width = 8, height = 4.5)
...
scatter_plot <- ggplot(data_low_high, aes(x = Min_wage, y = Adopt, color = factor(Relig))) +
  ...
  labs(x = "Support for minimum wage", y = "Support for stepchild adoption", title = "Low tightness, high consensus") +
  scale_color_manual(values = c("0" = "#00BFFF", "1" = "#E4717A"), labels = c("0" = "No", "1" = "Yes")) +  # Define colors and labels for Relig
  guides(color = guide_legend(title = "Relig"))  # Add legend with the title "Relig"
...
# Display the scatterplot with the added text
ggsave(here("Processing", "low_high.jpg"), width = 8, height = 4.5)
