...
image_write(combined_img, path = here("Output", "Article", "Figure_2.jpg"), quality = 100)
...
# Save
ggsave(here("Output", "Article", "Figure_3.jpg"), facet_r2_plot, , width = 12, height = 12, dpi = 300)
```

## Table 2 and assumptions
...
save_as_docx(summary_flextable, path = here("Output", "Article", "Mann_Whitney_Results.docx"))
```
