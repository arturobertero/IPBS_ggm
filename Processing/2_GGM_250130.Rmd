...
ggsave(here("Output", "Article", "Figure_2_w.jpg"), facet_r2_plot, , width = 16, height = 9, dpi = 300)
```
...
jpeg(here("Output", "Article", "Figure_3.jpg"), 
     height = 3508, width = 2480, quality = 100)  
...
```{r}
# Multiplot for Left and Right only
jpeg(here("Output", "Article", "Figure_3_w.jpg"), 
     width = 3840, height = 2160, quality = 100)  
